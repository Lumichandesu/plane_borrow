...
class HistoryStudent3 extends StatefulWidget {
  final String userId; // เพิ่มตัวแปร userId

  const HistoryStudent3({super.key, required this.userId});

  @override
  State<HistoryStudent3> createState() => _HistoryStudent3State();
}

class _HistoryStudent3State extends State<HistoryStudent3> {
  
 Future<List<HistoryItem>> fetchHistoryItems(String userId) async {
  final response =
      await http.post(Uri.parse('http://192.168.1.3:3000/HistoryStudent/${widget.userId}'));
